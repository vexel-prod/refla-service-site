...
const FEATURES: Array<{ title: string; text: string; icon: string }> = [
  ...
  },
  {
    ...
    text: 'Привезем и установим за один день, а еще оставим после себя порядок!',
    icon: '🏎️',
  },
  {
  ...
  {
    title: 'Гарантия 365 дней!',
    text: 'На монтаж и материалы. Мы отвечаем за качество установки',
    icon: '🛡️',
  },
]
